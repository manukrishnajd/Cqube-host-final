...
const AddNotification = () => {
  ...
  const tableHeaders = ['Message', 'Reciever', 'Date', '']
  const UiForViewData = (
    <>
  ...
  return (
    <div className=" rounded-2xl flex flex-wrap text-center items-center mb-4 gap-6 bg-slate-400 p-4 p-10 text-black">
      <form onSubmit={handlesubmit}>
        <input
          type="text"
          className="w-400 p-4 mb-2 me-2  border rounded h-10"
          placeholder="message"
          name="message"
          id=""
        ...
        <select
          name="receiver"
          className="w-400 me-2  mb-2 ms-2 border rounded h-10"
          onChange={handlechange}
          id=""
        >
        ...
        <select
          name="receiver"
          id=""
          className="w-400  mb-2  border rounded h-10"
          onChange={handlechange}
        >
        ...
        <input
          type="submit"
          className="bg-slate-600 hover:bg-black text-white ps-4 pe-4 pt-2 pb-2 rounded w-400"
          value="Send"
        />
      </form>
