...
const TrainerNavbar = (props) => {
  ...
  return (
    <div className="flex    bg-slate-600 h-fit w-full z-50 justify-between p-2 relative">
      ...
      <div className="flex">
        ...
        {isClicked.notification && <TrainerNotification />}
        {isClicked.userProfile && <TrainerProfile />}
      </div>
    </div>
  );
};
