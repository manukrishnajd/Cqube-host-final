...
const AttendPie = () => {
  ...
  return (
    <div className=" bg-white dark:bg-secondary-dark-bg rounded-3xl mt-8">
      <div className='flex align-bottom justify-end p-10'>
      <button
      ...
      {filter && (
        <>
          <form onSubmit={submitDate} className="max-w-xs mx-auto mt-8 p-16">
            <div className="mb-4">
              <label
      ...
      <Doughnut
        ...
        legendVisiblity
        height="full"
        className=" bg-white dark:bg-secondary-dark-bg rounded-3xl mt-8"
      />
    </div>
  )
}
