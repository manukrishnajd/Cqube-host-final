...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock, AiFillHome, AiTwotoneReconciliation } from 'react-icons/ai';
import { FiShoppingBag, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsInboxFill } from 'react-icons/bs';
import { BiColorFill } from 'react-icons/bi';
import { IoMdContacts } from 'react-icons/io';
import { RiContactsLine, RiStockLine } from 'react-icons/ri';
import { MdOutlineSupervisorAccount } from 'react-icons/md';
import { HiAcademicCap, HiOutlineRefresh } from 'react-icons/hi';
import { TiTick } from 'react-icons/ti';
import { GiCaptainHatProfile, GiLouvrePyramid, GiTeacher } from 'react-icons/gi';
...
export const AttendanceChart = [
  { x: 'Absent', y: 18, text: '10%' },
  { x: 'Present', y: 8, text: '90%' },
 
];
export const StudentCourseChart = [
  { x: 'Mern', y: 18, text: '10%' },
  { x: 'Flutter', y: 8, text: '90%' },
];
